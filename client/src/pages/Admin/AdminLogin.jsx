...
export default function AdminLogin() {
  ...
  return (
    <div className="h-screen w-screen bg-[#fdf3e7] flex items-center justify-center overflow-hidden">
      <div className="flex w-full h-full max-w-5xl items-center justify-center gap-6 px-6">
        ...
        <div className="hidden lg:flex flex-col justify-between flex-1 h-full max-h-[600px] relative pr-4">
          ...
          <div className="relative z-10 pt-8">
            ...
            <h2 className="text-3xl xl:text-4xl font-extrabold text-[#FFB700] leading-tight mb-3">
              ADMIN !
            </h2>
            <p className="text-sm text-gray-700 leading-relaxed">Manage products, orders, users</p>
            <p className="text-sm text-gray-700 mb-2">and grow your business.</p>
            <p className="text-base font-bold text-gray-900">House of Cambridge</p>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-md p-6 w-full max-w-sm flex-shrink-0">
          ...
          {/* Error */}
          {error && (
            <div className="flex items-start gap-2 bg-red-50 border border-red-200 text-red-600 text-xs rounded-lg px-3 py-2.5 mb-3">
              <span className="mt-0.5">⚠️</span>
              <span>
                {error}{" "}
                <button type="button" onClick={() => setError("")} className="underline hover:text-red-800">
                  reset your password.
                </button>
              </span>
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <div>
              ...
              <input
                ...
                placeholder="adlim@houseofcambridge.co.uk"
                required
            ...
            <div>
              <div className="flex justify-between items-center mb-1">
                ...
                <button type="button" className="text-xs text-gray-500 hover:text-yellow-500 underline">
                  Forgot Password?
                </button>
              </div>
